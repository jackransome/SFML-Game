...
enum keys {a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, n1, n2, n3, n4, n5, n6, n7, n8, n9, n0, leftArrow, rightArrow, upArrow, downArrow, escape, tab, backSpace, space, lControl, rControl, lShift, rShift, enter, mouseL, mouseR, mouseM};
...
struct KeyStruct {
	...
	int rControl; int lShift; int rShift; int enter; int n1; int n2; int n3; int n4; int n5; int n6; int n7; int n8; int n9; int n0; int mouseL; int mouseR; int mouseM;
};
