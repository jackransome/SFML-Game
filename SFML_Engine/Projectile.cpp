...
void Projectile::draw(){
	pSpriteCollection->drawBeamLight(lastPosition, position, glm::vec3(255, 150, 100), 2, 1);
	pSpriteCollection->drawBeamLight(lastPosition, position, glm::vec3(255, 150, 100), 2, 0);
